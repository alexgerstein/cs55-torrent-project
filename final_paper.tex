...
\bibitem{torrent-poisoning} http://en.wikipedia.org/wiki/Torrent\_poisoning
...
\bibitem{Netflix-Youtube} http://cir.ca/news/sandvine-internet-traffic-reports
\bibitem{illegal-downloading} (http://www.ehow.com/info\_10004321\_define-illegal-downloading.html)
\bibitem{AcceptableUsePolicy} (http://www.dartmouth.edu/comp/about/policies/acceptable\_use\_policy.html
\bibitem{illegalFilesTorrent} (http://arstechnica.com/tech-policy/2010/07/only-03-of-files-on-bit-torrent-confirmed-to-be-legal/)
\bibitem{DartmouthCopyright} (http://www.dartmouth.edu/copyright/peer2peer/index.html\#P2P)
\end{thebibliography}
