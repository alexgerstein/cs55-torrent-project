...
Generally, the number of students who received DMCA complaints each year is relatively small compared to the size of the student body. The 466 complaints from 2012, for example, is relatively small compared to its approximately 6000 undergraduate and graduate students. These numbers indicate that only 7.8\% of students receive complaints in a year, but it's important to note that this number is likely smaller due to the errors of locating IP addresses on the network that Goldstein mentioned.

For the question in which students were asked if Dartmouth records when someone torrents a file, it is clear that the 21.5\% of students who answered NO underestimated the amount information to which Dartmouth's network administrators have access. It is important to note, however, that while they have access to this information, they do not monitor it unless they feel it is putting too much of a strain on the network.
...
Between our survey data which indicates that students

- Student perception: Students perceive that other students torrent at a higher rate than is actually reported.
- Network patterns: Use of BitTorrent may be falling in time, but it still accounts for 4.8\% of total network data traffic and 4758 GB of data were downloaded via BitTorrent in the 30 Day period ending November 8, 2013.
- Relationship:

\subsection{Policy Recommendations}
-- Authors - The issue may self-regulate itself out of existence, if the trends continue of individuals increasingly relying on streaming services for content as opposed to downloading or purchased the material.
-- Participant 119 - ``As for reducing torrenting, if [Dartmouth] had campus-wide Netflix, HBOGo, Hulu+ and Spotify Unlimited accounts, I bet that would stop 90\% of people from torrenting things. Those obviously have a pretty limited selection, and I'm pretty sure there's no way to do corporate licensing for those, but I would guess most people would be put-off enough by the hassle of finding a high-quality torrent that they would just find a legal option on Netflix etc. if the services were offered for free to students with valid Dartmouth [authentication].'' (More digital access to movies / streaming is a common theme among participants, explicitly mentioned by 8 of 34 (23.5\%) of students who responded to the optional survey question on how Dartmouth could reduce student torrenting.)
-- A number of participants -- 5 of 34 (14.7\%) students -- recommended more significant disciplinary action or consequences, including warnings from Dartmouth College Computing Services, banning individuals from Dartmouth wireless access for a set period of time, and allowing students to see their personal network bandwidth usage.
-- 16 of the 34 participants who responded (47.1\%) stated that no changes to the policy were necessary.
-- The remaining 5 of 34 (14.7\%) of students recommended various forms of decreasing costs to students of textbooks, software, or other applications that students tend to resort to torrenting to acquire.
